        ...
        <div class="boss-account row">
            <div class="title-account-div col-sm-3">
            	<ul class="nav nav-pills nav-stacked" style="margin-top: 55px;">
				  ...
				  <li role="presentation" class="active"><a href="admin_manage.html">Quản lí bài đăng</a></li>
				  <li role="presentation" ><a href="changepass.html">Đổi mật khẩu</a></li>
				</ul>
            </div>
            <div class="DoiMK col-sm-9">
                <div class="table_manage">
                    <h3 id="QL"><strong>Quản lý</strong></h3>
                <div class="table_manage_posts" >
                    <table id="results" class="table table_posts table-striped table-hover">
                        ...
                        <tbody>
                        	<%int i = 1; %>
                        	<c:forEach var="bd" items="${baidangs}">
	                            <tr class="tr1">
	                                <th scope="row"><%=i++ %></th>
	                                <td class="col-md-4">${bd.tieude}</td>
	                                <td class="">${bd.ngaydang}</td> 
	                                <td class="">${bd.chutro.getMact()}</td>
	                                <td class=""><a href="detail_room.html?mabd=${bd.mabd}">Xem</a></td>
	                                <td class="col-md-3">
	                                   <button id="btn2" class="btn btn-success" data-toggle="modal" data-target="#ThongBao">Thông báo</button> 
	                                    <a id="btn2"  class="btn btn-warning" onclick="return confirm('Bạn có muốn xóa bài đăng này không?')" 
												href="delbaidang_admin?mabd=${bd.mabd}">Xóa
										</a>
	                                </td> 
								</tr>
							</c:forEach>  
