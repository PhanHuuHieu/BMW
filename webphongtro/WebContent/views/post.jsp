...
<body>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" name="tieude" id="tieude" placeholder="Hãy đặt tiêu đề đầy đủ nghĩa, khách sẽ quan tâm hơn"  maxlength="100" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="sodienthoai"  id="sodienthoai" placeholder="Nhập đúng số điện thoại để tiện cho khách liên hệ" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="number" min="1" class="form-control" name="giachothue" id="giachothue" placeholder="Giá cho thuê (VNĐ)" required>
                        </div>
                        <div class="col-sm-6">
                            <label for="dongvigiachothue" class="col-sm-12 control-label">Số người <span class="red_require">(*)</span></label>
                            <input type="number" min="1" class="form-control" name="songuoi" id="songuoi" value="1" required>
                        </div>
                    </div>
                </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="number" min="1" class="form-control" name="dientich" id="dientich" placeholder="Nhập diện tích (Đơn vị m²)" required>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input value="" id="pac-input" type="text" class="form-control" name="diachi" placeholder="Hãy nhập địa chỉ chính xác để khách dễ tìm hơn" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input style="display: none;" name="toado" id="i1" type="text" value="">
		...
		<div class="shadow">
            <div class="group_fields">
                ...
                <p class="bg-success">Mô tả thông tin rỏ ràng, đầu đủ. Hãy viết chữ có dấu để Tin đăng được quan tâm nhiều hơn</p>
                   <textarea style="margin-top: 3%;" name="mota" class="form-control" rows="8" placeholder="Mô tả thông tin" ></textarea>
                </div>
            </div>
        </div>
      ...
      function initAutocomplete() {
        ...
        searchBox.addListener('places_changed', function() {
          ...
          places.forEach(function(place) {
            ...
            $(function(){
                var inputVal = $('#i1').val(place.geometry.location);
            });
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAQl0XVU1goVsDeqX8z46G8R4grIxd_nSQ&libraries=places&callback=initAutocomplete"
         async defer></script>
     <% String message = (String)request.getAttribute("dangtin");%>
